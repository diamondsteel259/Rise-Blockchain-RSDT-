#!/usr/bin/env python3
"""
Resistance Blockchain GUI Miner - Windows Version
...
class RSDTGUIMinerWindows:
    ...
    def setup_ui(self):
        ...
        self.start_button = tk.Button(button_frame, text="Start Mining", command=self.start_mining, 
                                     bg='#2a2a2a', fg='#00ff00', font=('Segoe UI', 12, 'bold'))
        self.start_button.pack(side='left', padx=5)
        
        self.stop_button = tk.Button(button_frame, text="Stop Mining", command=self.stop_mining, 
                                    bg='#2a2a2a', fg='#ff0000', font=('Segoe UI', 12, 'bold'), state='disabled')
